...
from backend.app.gemini_live.api.routes import router as gemini_live_router
...
# Essential Core Chatbot Routers (Maths, Memory, Info Analysis & Everyday Tasks)
app.include_router(brain_router)
app.include_router(memory_router)
app.include_router(tools_router)

# Auxiliary Routers (Commented out for clean & lightweight execution; can be enabled as needed)
